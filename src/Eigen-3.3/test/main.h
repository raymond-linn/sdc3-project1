...
// The following includes of STL header have to be done _before_ the
// definition of macros min() and max().  The reason is that many STL
// implementations will not work properly as the min and max symbols collide
// with the STL functions std:min() and std::max().  The STL header may check
...
// function name.
//
// All STL header used by Eigen should be included here.  Because main.h is
// included before any Eigen header and because the STL header are guarded
